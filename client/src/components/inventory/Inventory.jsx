...
const Inventory = () => {
    ...
    const handleMaterialChange = async (materialId) => {
        // Fetch data for the selected raw material
        try {
            const response = await axios.get(`http://apps.copalcor.co.za:4040/api/rawMaterials/${materialId}`);
    ...
    const handleDelete = async (entryId) => {
        ...
        try {
            await axios.delete(`http://apps.copalcor.co.za:4040/api/rawMaterials/${selectedMaterial}/entry/${entryId}/delete`);
    ...
    const handleEditSubmit = async (e) => {
        ...
        try {
            await axios.put(`http://apps.copalcor.co.za:4040/api/rawMaterials/${selectedMaterial}/entry/${editEntryId}/edit`, editedData);

            // Fetching entries for the selected material from the database
            const response = await axios.get(`http://apps.copalcor.co.za:4040/api/rawMaterials/${selectedMaterial}`);
            const materialEntries = response.data.entry;
            ...
            for (let i = editedEntryIndex + 1; i < materialEntries.length; i++) {
                ...
                await axios.put(`http://apps.copalcor.co.za:4040/api/rawMaterials/${selectedMaterial}/entry/${materialEntries[i]._id}/edit`, materialEntries[i]);
            }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Submit new entry
            await axios.post(`http://apps.copalcor.co.za:4040/api/rawMaterials/${selectedMaterial}/entry`, inputData);
